...
# ── 브랜드 팔레트 (제철이 가득한 한상) ────────────────────────
# 브랜드_로고_CI_확정.md 의 확정 컬러: 네이비 #14283A, 오렌지 #FF7A1C
NAVY = (20, 40, 58)             # #14283A
NAVY_DEEP = (11, 24, 36)
PAPER = (247, 245, 241)
WHITE = (255, 255, 255)
GREY = (122, 132, 140)
POINT = (255, 122, 28)          # #FF7A1C 강조 키워드
LINE = (219, 216, 209)
...
def draw_card(card, index, total, progress):
    ...
    f_brand = font("black", 40)
    d.text((72, 92), "제철이 가득한 한상", font=f_brand, fill=WHITE)
    f_sub = font("medium", 26)
    d.text((72, 150), "산지에서 식탁까지", font=f_sub, fill=(166, 186, 204))
